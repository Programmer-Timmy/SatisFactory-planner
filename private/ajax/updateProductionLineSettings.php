...
if ($_POST) {
    ...
    $productionLine = ProductionLines::getProductionLineById($_POST['productionLineId']);

    if (empty($productionLine) || !ProductionLines::validateAccess($_POST['gameSaveId'], $productionLineId, $_SESSION['userId'])) {
