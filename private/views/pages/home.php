...
?>
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-3">
                <div class="d-flex justify-content-end">
                    ...
                    <span id="popover_add_game_save" data-bs-toggle="popover" data-bs-placement="bottom"
                          opend="<?= empty($gameSaves) ? 'true' : 'false' ?>"
                          data-bs-trigger="manual"
                          data-bs-html="true"
                          title="You don't have any game saves"
                          data-bs-content="You can add a game save by clicking the button above. Or ask a friend to invite you to their game save.">
        ...
        <?php if (empty($gameSaves)) : ?>
            <h1 class="text-center">No Game Saves Found</h1>
        <?php else : ?>
            <!--    show cards-->
            <div class="row">
...
<?php if (empty($gameSaves)) : ?>
    <script>$(document).ready(function () {
            $('#popover_add_game_save').popover('show');
        });</script>
<?php endif; ?>